...
<div class="grid md:grid-cols-5 gap-4 mb-6">
    <div class="bg-white rounded-xl shadow p-4"><div class="text-xs text-slate-500">Pemasukan</div><div class="text-xl font-bold">{{ \App\Support\Money::rupiah($summary['total_income']) }}</div></div>
    <div class="bg-white rounded-xl shadow p-4"><div class="text-xs text-slate-500">Pengeluaran</div><div class="text-xl font-bold">{{ \App\Support\Money::rupiah($summary['total_expense']) }}</div></div>
    <div class="bg-white rounded-xl shadow p-4"><div class="text-xs text-slate-500">Bersih</div><div class="text-xl font-bold">{{ \App\Support\Money::rupiah($summary['net_income']) }}</div></div>
...
<div class="bg-white rounded-xl shadow overflow-hidden">
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full text-sm">
            <thead class="bg-slate-50"><tr><th class="p-3 text-left">Nomor</th><th class="p-3 text-left">Tanggal</th><th class="p-3 text-left">Kapal</th><th class="p-3 text-right">Bersih</th><th class="p-3 text-left">Status</th></tr></thead>
            <tbody>

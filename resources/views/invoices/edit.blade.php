...
<div class="sticky bottom-24 md:static z-20 rounded-[1.5rem] bg-white/95 backdrop-blur border border-slate-100 shadow-lg p-3"><button class="w-full md:w-auto min-h-[54px] rounded-2xl bg-teal-600 text-white px-6 font-black shadow-lg shadow-teal-700/20">Update Draft</button></div>
</form>
@endsection

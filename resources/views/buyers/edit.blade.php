...
<div class="mb-5">
    ...
    <h1 class="text-2xl md:text-3xl font-black tracking-tight">Edit Pembeli</h1>
    <p class="text-sm text-slate-500 mt-1">Perbarui data pembeli opsional.</p>
</div>
<form method="POST" action="{{ route('buyers.update', $buyer) }}" class="bg-white rounded-[1.75rem] shadow-sm border border-slate-100 p-4 md:p-6 space-y-4 max-w-2xl">
    @csrf @method('PUT')
    @include('buyers.form')
